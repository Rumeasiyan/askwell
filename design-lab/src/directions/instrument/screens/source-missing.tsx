        ...
        <Main>
          <Panel>
            <div className="flex items-baseline gap-2">
              <span className="h-1.5 w-1.5 shrink-0 border border-[var(--inferred)]" />
              <span className="text-[13px] text-[var(--inferred)]">This file has moved</span>
            </div>
            ...
            <div className="mt-2 rounded-[var(--radius)] border border-[var(--rule)] bg-[var(--sunk)] px-3 py-2 text-[12.5px] text-[var(--muted)]">
          ...
          <Panel>
            <div className="flex items-baseline gap-2">
              <span className="h-1.5 w-1.5 shrink-0 bg-[var(--rule)]" />
              <span className="text-[13px] text-[var(--muted)]">Deleted on 6 June</span>
            </div>
            <H>old-handbook.pdf</H>
            <Prose className="mt-2 text-[15px] text-[var(--muted)]">
