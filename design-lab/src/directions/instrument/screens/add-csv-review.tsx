        ...
        <Main>
          ...
          <Table
            ...
            rows={[
              ...
              ['issued_on', <span className="text-[var(--inferred)]">date — format unclear</span>, '03/04/2026', <span className="inline-flex items-center gap-1.5"><Mark /> needs you</span>],
              ['amount_gbp', 'number', '1,200.00', <span className="inline-flex items-center gap-1.5"><Mark /> I guessed</span>],
              ['st_cd', <span className="text-[var(--inferred)]">code — meaning unknown</span>, 'O / P / W', <span className="inline-flex items-center gap-1.5"><Mark /> needs you</span>],
              ['column 7', <span className="text-[var(--inferred)]">no header</span>, '2026-05-12', <span className="inline-flex items-center gap-1.5"><Mark /> needs you</span>],
            ]}
          />
