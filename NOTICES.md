...
Verified against the model's own registry entry before being written here (`AGENTS.md` §4); C9 requires every one of these to be GPLv3-compatible, to permit redistribution and commercial use, and to be ungated. A model you swap in yourself is your own responsibility to check against the same terms.
