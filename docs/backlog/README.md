...
- **Update checking is opt-in and says only "newer".** Decided 2026-09-21 (`docs/decisions.md`): people who declined it learn about a new version by looking, and nobody can be told a version is *broken*. M7-OPS-DOC-165 names that incident-response limitation in `docs/rollback-and-incidents.md` §4.3 rather than glossing over it.
